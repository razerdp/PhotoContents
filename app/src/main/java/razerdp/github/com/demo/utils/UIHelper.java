...
public class UIHelper {
    ...
    public static int dipToPx(float dip) {
        return (int) (dip * PhotoContentsDemoApp.getAppContext().getResources()
    ...
    public static int pxToDip(float pxValue) {
        final float scale = PhotoContentsDemoApp.getAppContext().getResources()
    ...
    public static int sp2px(float spValue) {
        final float fontScale = PhotoContentsDemoApp.getAppContext().getResources()
    ...
    public static int getScreenWidthPix(@Nullable Context context) {
        if (context == null) context = PhotoContentsDemoApp.getAppContext();
    ...
    public static void ToastMessage(String msg) {
        Toast.makeText(PhotoContentsDemoApp.getAppContext(), msg, Toast.LENGTH_LONG).show();
    }
