...
import razerdp.github.com.demo.model.entity.CommentInfo;
...
import razerdp.github.com.demo.model.entity.UserInfo;
import razerdp.github.com.demo.net.base.BaseRequestClient;
import razerdp.github.com.demo.utils.ToolUtil;

import static razerdp.github.com.demo.model.entity.CommentInfo.CommentFields.MOMENT;
import static razerdp.github.com.demo.model.entity.CommentInfo.CommentFields.REPLY_USER;
        ...
        for (int i = 0; i < momentsList.size(); i++) {
            ...
            likesQuery.findObjects(new FindListener<UserInfo>() {
                ...
                public void done(List<UserInfo> list, BmobException e) {
                    ...
                    commentQuery.include(MOMENT + "," + REPLY_USER + "," + MomentsFields.AUTHOR_USER);
